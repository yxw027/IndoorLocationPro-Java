...
import com.hust.indoorlocation.MyApplication
...
object SettingUtil {
    ...
    private val setting = PreferenceManager.getDefaultSharedPreferences(MyApplication.mContext)

    /**
     * 获取是否开启无图模式
     */
    fun getIsNoPhotoMode(): Boolean {
        return setting.getBoolean("switch_noPhotoMode", false) //&& NetWorkUtil.isMobile(com.ve.mvvm.app.App.context)
    }
     ...
     */
    fun getColor(): Int {
        val defaultColor = MyApplication.mContext.resources.getColor(R.color.colorPrimary)
